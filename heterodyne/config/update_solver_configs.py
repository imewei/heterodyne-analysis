...
Updates all heterodyne configuration files with optimal solver parameters
...
def main():
    ...
    # Get the directory where this script is located (heterodyne/config/)
    ...
    print("=" * 70)
    print("Heterodyne Solver Configuration Optimizer")
