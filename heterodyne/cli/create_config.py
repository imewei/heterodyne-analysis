...
def create_config_from_template(
    ...
    if mode == "static_isotropic":
        ...
        print(f"6. Run analysis with: heterodyne --config {output_path}")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Create heterodyne analysis configuration from mode-specific templates",
...
Examples:
  ...
  heterodyne-config --output my_flow_config.json
  ...
  heterodyne-config --mode static_anisotropic --sample collagen \
