...
from heterodyne.tests.import_analyzer import AdvancedImportAnalyzer
from heterodyne.tests.import_analyzer import EnterpriseImportAnalyzer
from heterodyne.tests.import_analyzer import ImportInfo
from heterodyne.tests.import_analyzer import SafetyChecker
...
class TestIntegrationWithRealAnalyzer:
    ...
    def setup_method(self):
        ...
        # Ensure we're testing against the actual heterodyne package
        assert (self.package_root / "heterodyne").exists()
        assert (
            self.package_root / "heterodyne" / "tests" / "import_analyzer.py"
        ).exists()

    def test_real_package_analysis(self):
        """Test analysis on the actual heterodyne package."""
