...
# Add heterodyne to path for testing
sys.path.insert(0, str(Path(__file__).parent.parent))


try:
    from heterodyne.cli.run_heterodyne import create_argument_parser
except ImportError:
...
class TestShellCompletion:
    ...
    @patch.dict(
        "os.environ",
        {"_ARGCOMPLETE": "1", "COMP_LINE": "heterodyne --method ", "COMP_POINT": "18"},
    )
