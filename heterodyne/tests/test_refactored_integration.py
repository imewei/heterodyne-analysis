    ...
    def test_chi_squared_calculation_accuracy(self):
        ...
        try:
            ...
            try:
                ...
                with patch(
                    "heterodyne.analysis.core.HeterodyneAnalysisCore.load_experimental_data"
                ) as mock_load:
                    # Mock data loading
                    ...
                    with patch(
                        "heterodyne.analysis.core.HeterodyneAnalysisCore.calculate_c2_single_angle_optimized"
                    ) as mock_c2:
                        # Mock C2 calculation
                        mock_c2.return_value = np.random.rand(n_time, n_time)

                        # Test that the refactored methods can be called
                        analyzer = HeterodyneAnalysisCore(config_path)
...
class TestRefactoredOptimization:
    ...
    def test_gurobi_options_refactored(self):
        ...
        try:
            ...
            pytest.skip("heterodyne.optimization.classical not available")
...
class TestCompositionFramework:
    ...
    def test_result_monad_operations(self):
        ...
        try:
            ...
            pytest.skip("heterodyne.core.composition not available")
    ...
    def test_workflow_components(self):
        ...
        try:
            ...
            pytest.skip("heterodyne.core.workflows not available")
