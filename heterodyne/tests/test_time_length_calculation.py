...
class TestAnalysisCoreIntegration:
    """Integration tests for HeterodyneAnalysisCore time_length."""

    def test_core_time_length_calculation(self):
        """Test that HeterodyneAnalysisCore calculates time_length correctly."""
        # Test the formula directly rather than full HeterodyneAnalysisCore initialization
        # (HeterodyneAnalysisCore requires file-based config loading which is complex to mock)
