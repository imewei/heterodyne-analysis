...
from heterodyne.core.lazy_imports import BatchDependencyLoader
from heterodyne.core.lazy_imports import HeavyDependencyLoader
from heterodyne.core.lazy_imports import LazyImportError
from heterodyne.core.lazy_imports import clear_import_cache
from heterodyne.core.lazy_imports import get_import_performance_report
from heterodyne.core.lazy_imports import preload_critical_dependencies
...
@pytest.mark.xdist_group(name="serial_lazy_loading")
class TestIntegrationWithMainPackage:
    ...
    def test_preload_function_integration(self):
        ...
        heterodyne.preload_scientific_dependencies()
