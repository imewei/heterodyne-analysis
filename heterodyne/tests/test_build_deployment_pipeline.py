...
class DeploymentPipeline:
    ...
    def setup_deployment_targets(self) -> list[DeploymentTarget]:
        ...
        targets = [
            ...
            DeploymentTarget(
                ...
                python_version="3.11",
                requirements_file="requirements.txt",
                build_command="docker build -t heterodyne-analysis .",
                test_command="docker run --rm heterodyne-analysis python -m pytest",
    ...
    def _create_build(self) -> dict[str, Any]:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            wheel_path = temp_path / "heterodyne_analysis-1.0.0-py3-none-any.whl"
            ...
            sdist_path = temp_path / "heterodyne_analysis-1.0.0.tar.gz"
