...
from heterodyne.core.initialization_optimizer import DependencyAnalyzer
from heterodyne.core.initialization_optimizer import InitializationOptimizer
from heterodyne.core.initialization_optimizer import InitializationStrategy
from heterodyne.core.initialization_optimizer import get_initialization_optimizer
from heterodyne.core.initialization_optimizer import optimize_package_initialization
from heterodyne.core.initialization_optimizer import profile_startup_performance
...
class TestDependencyAnalyzer:
    ...
    def test_analyzer_initialization(self):
        ...
        analyzer = DependencyAnalyzer("heterodyne")
        assert analyzer.package_name == "heterodyne"
    ...
    def test_dependency_analysis(self):
        ...
        with (
            ...
            patch.object(analyzer, "_find_critical_path", return_value=["heterodyne"]),
        ):
    ...
    def test_path_to_module_name_conversion(self):
        ...
        # Create mock paths
        package_path = Path("/path/to/heterodyne")
        test_file = Path("/path/to/heterodyne/core/kernels.py")

        module_name = analyzer._path_to_module_name(test_file, package_path)
        assert module_name == "heterodyne.core.kernels"
    ...
    def test_heavy_import_detection(self):
        ...
        analyzer.dependency_graph = {
            "heterodyne.core.numpy_heavy": set(),
            "heterodyne.analysis.scipy_heavy": set(),
            "heterodyne.regular.module": set(),
        }
...
class TestInitializationOptimizer:
    ...
    def test_optimizer_initialization(self):
        ...
        optimizer = InitializationOptimizer("heterodyne")
        assert optimizer.package_name == "heterodyne"
...
class TestIntegrationWithMainPackage:
    ...
    def test_main_package_optimization_functions(self):
        ...
        assert hasattr(heterodyne, "optimize_initialization")
        assert hasattr(heterodyne, "get_startup_performance_report")
    ...
    def test_optimize_initialization_function(self):
        ...
        with patch(
            "heterodyne.core.initialization_optimizer.optimize_package_initialization"
        ) as mock_opt:
            from heterodyne.core.initialization_optimizer import InitializationStrategy
            ...
            result = heterodyne.optimize_initialization()
    ...
    def test_startup_performance_report_function(self):
        ...
        report = heterodyne.get_startup_performance_report()
    ...
    def test_automatic_optimization_application(self):
        ...
        env = os.environ.copy()
        env["HETERODYNE_OPTIMIZE_STARTUP"] = "true"

        # Import package in subprocess with optimization enabled
        result = subprocess.run(
            [sys.executable, "-c", "import heterodyne; print('Success')"],
            check=False,
            env=env,
            capture_output=True,
            text=True,
    ...
    def test_optimization_environment_variable_disabled(self):
        ...
        env = os.environ.copy()
        env["HETERODYNE_OPTIMIZE_STARTUP"] = "false"
...
class TestPerformanceBenchmarks:
    ...
    def test_startup_time_benchmark(self):
        ...
        for _ in range(5):
            start_time = time.perf_counter()
            result = subprocess.run(
                [sys.executable, "-c", "import heterodyne"],
                check=False,
                capture_output=True,
                text=True,
            )
