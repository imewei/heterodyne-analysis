...
class TestIntegrationWithHeterodynePackage:
    """Integration tests with the actual heterodyne package."""

    def test_analyze_heterodyne_package(self):
        """Test analysis of the actual heterodyne package."""
        package_root = Path("heterodyne")
        if not package_root.exists():
            pytest.skip("Heterodyne package directory not found")
    ...
    def test_specific_files_analysis(self):
        ...
        target_files = [
            "heterodyne/core/security_metrics.py",
            "heterodyne/ui/cli_enhancer.py",
            "heterodyne/core/config.py",
        ]
...
if __name__ == "__main__":
    ...
    if package_root.exists():
        ...
        print("Package directory 'heterodyne' not found")
