...
import heterodyne.performance.startup_monitoring as startup_monitoring_module
from heterodyne.performance.startup_monitoring import PerformanceBaseline
from heterodyne.performance.startup_monitoring import RegressionAlert
from heterodyne.performance.startup_monitoring import StartupMetrics
from heterodyne.performance.startup_monitoring import StartupPerformanceMonitor
from heterodyne.performance.startup_monitoring import check_startup_health
from heterodyne.performance.startup_monitoring import establish_default_baselines
from heterodyne.performance.startup_monitoring import get_startup_monitor
...
class TestStartupPerformanceMonitor:
    ...
    def setup_method(self):
        ...
        self.monitor = StartupPerformanceMonitor(
            package_name="heterodyne", baseline_dir=Path(self.temp_dir)
        )

    def test_monitor_initialization(self):
        """Test monitor initialization."""
        assert self.monitor.package_name == "heterodyne"
...
class TestIntegrationWithMainPackage:
    ...
    def test_main_package_monitoring_functions(self):
        ...
        assert hasattr(heterodyne, "establish_performance_baseline")
        assert hasattr(heterodyne, "check_performance_health")
        assert hasattr(heterodyne, "monitor_startup_performance")
        assert hasattr(heterodyne, "get_performance_trend_report")
    ...
    def test_establish_baseline_function(self):
        ...
        with patch(
            "heterodyne.performance.startup_monitoring.StartupPerformanceMonitor.establish_baseline"
        ) as mock_establish:
            mock_baseline = PerformanceBaseline(
                name="test_main",
                target_import_time=2.0,
            ...
            result = heterodyne.establish_performance_baseline(
    ...
    def test_performance_health_check_function(self):
        ...
        # Mock to avoid actual measurement
        with patch(
            "heterodyne.performance.simple_monitoring.SimpleStartupMonitor.check_startup_health"
        ) as mock_health:
    ...
    def test_monitor_startup_performance_function(self):
        ...
        # Mock to avoid actual measurement
        with patch(
            "heterodyne.performance.simple_monitoring.SimpleStartupMonitor.measure_startup_time"
        ) as mock_measure:
            from heterodyne.performance.simple_monitoring import SimpleStartupMetrics
            ...
            result = heterodyne.monitor_startup_performance(iterations=3)
