...
class TestHighComplexityFunctions:
    ...
    def test_calculate_chi_squared_optimized_numerical_accuracy(self):
        ...
        try:
            from heterodyne.analysis.core import calculate_chi_squared_optimized
    ...
    def test_performance_monitoring_functions_metrics(self):
        ...
        try:
            from heterodyne.performance.baseline import identify_bottlenecks
    ...
    def test_ml_acceleration_functions_prediction_accuracy(self):
        ...
        try:
            from heterodyne.optimization.ml_acceleration import accelerate_optimization
