...
def analyze_specific_refactored_functions():
    ...
    refactored_functions = [
        ("run_analysis", "heterodyne/cli/run_heterodyne.py"),
        ("calculate_chi_squared_optimized", "heterodyne/analysis/core.py"),
        ("plot_simulated_data", "heterodyne/cli/run_heterodyne.py"),
        ("_run_gurobi_optimization", "heterodyne/optimization/classical.py"),
    ]
